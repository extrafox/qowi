...
class Header:
    ...
    def __init__(self):
        ...
        self.wavelet_encode_levels = None
    ...
    def write(self, bitstream: BitStream):
        ...
        bitstream.append(Bits(uint=self.wavelet_encode_levels, length=WAVELET_ENCODE_LEVELS_BITS))
    ...
    def read(self, bitstream: BitStream):
        ...
        self.wavelet_encode_levels = bitstream.read(WAVELET_ENCODE_LEVELS_BITS).uint
