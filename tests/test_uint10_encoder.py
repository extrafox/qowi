...
class TestUint10Encoder(unittest.TestCase):

    def test_instantiation(self):
        bitstream = BitStream()
        e = Uint10Encoder(bitstream, 1024)
        self.assertIsInstance(e, Uint10Encoder)

    def test_encode_and_read_one_token(self):
        bitstream = BitStream()
        ...
        observed_token = tuple(entropy.decode_array(bitstream, 3))
